        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto justify-content-start">
            ...
            {currentUser ? ([
              ...
              <Nav.Link id="rate-my-peer" as={NavLink} to="/ratemypeer" key="ratemypeer">Rate-My-Peer</Nav.Link>,
            ]) : ''}
            <Nav.Link as={NavLink} to="/register" key="profiles">Profiles</Nav.Link>
            <Nav.Link as={NavLink} to="/calendar" key="calendar">Calendar</Nav.Link>
            <Nav.Link as={NavLink} to="/officehours" key="officehours">Office Hours</Nav.Link>
            <Nav.Link as={NavLink} to="/leaderboard" key="leaderboard">Leaderboard</Nav.Link>
            <Nav.Link as={NavLink} to="/studysesh" key="studysesh">Study Sessions</Nav.Link>
          </Nav>
