        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto justify-content-start">
            {currentUser ? ([
              ...
              <Nav.Link id="list-stuff-nav" as={NavLink} to="/listOH" key="list">Office Hours</Nav.Link>,
            ]) : ''}
            {Roles.userIsInRole(Meteor.userId(), 'admin') ? (
              <Nav.Link id="list-stuff-admin-nav" as={NavLink} to="/listStudent" key="admin">Admin</Nav.Link>
            ) : ''}
          </Nav>
